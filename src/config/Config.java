...
public class Config {
    ...
    public static String dbDataDir = "/var/www/public/scripts/data/actions-data.tsv"; //160.40.63.119
    //public static String dbURL = "jdbc:postgresql://localhost:15432/gis"; //localhost
    //public static String dbDataDir = "data/actions-data.tsv"; // localhost
